...
func (repository *volumeRepository) queryVolumeHandles(cond sq.Eq) ([]string, error) {
	...
	ctx := context.WithValue(context.Background(), ctxQueryNameKey, "volumeRepository-queryVolumeHandles")
...
func (repository *volumeRepository) UpdateVolumesMissingSince(workerName string, reportedHandles []string) error {
	...
	ctx := context.WithValue(context.Background(), ctxQueryNameKey, "volumeRepository-UpdateVolumesMissingSince")
	rows, err := repository.conn.QueryContext(ctx, query, args...)
	if err != nil {
		return err
	}
...
func (repository *volumeRepository) RemoveMissingVolumes(gracePeriod time.Duration) (int, error) {
	ctx := context.WithValue(context.Background(), ctxQueryNameKey, "volumeRepository-RemoveMissingVolumes")
...
func (repository *volumeRepository) RemoveDestroyingVolumes(workerName string, handles []string) (int, error) {
	ctx := context.WithValue(context.Background(), ctxQueryNameKey, "volumeRepository-RemoveDestroyingVolumes")
...
func (repository *volumeRepository) GetTeamVolumes(teamID int) ([]CreatedVolume, error) {
	ctx := context.WithValue(context.Background(), ctxQueryNameKey, "volumeRepository-GetTeamVolumes")
...
func (repository *volumeRepository) FindVolumesForContainer(container CreatedContainer) ([]CreatedVolume, error) {
	ctx := context.WithValue(context.Background(), ctxQueryNameKey, "volumeRepository-FindVolumesForContainer")
...
func (repository *volumeRepository) GetOrphanedVolumes() ([]CreatedVolume, error) {
	ctx := context.WithValue(context.Background(), ctxQueryNameKey, "volumeRepository-GetOrphanedVolumes")
...
func (repository *volumeRepository) DestroyFailedVolumes() (int, error) {
	ctx := context.WithValue(context.Background(), ctxQueryNameKey, "volumeRepository-DestroyFailedVolumes")
...
func (repository *volumeRepository) createVolume(
	...
	ctx := context.WithValue(context.Background(), ctxQueryNameKey, "volumeRepository-createVolume")
...
func getVolume(conn Conn, where map[string]interface{}) (CreatingVolume, CreatedVolume, error) {
	ctx := context.WithValue(context.Background(), ctxQueryNameKey, "volumeRepository-getVolume")
